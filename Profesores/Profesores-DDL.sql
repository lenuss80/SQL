...
CREATE TABLE IMPARTE(
    ...
    CONSTRAINT FK_IMPARTE-PROFESORES FOREIGN KEY(dni) REFERENCES PROFESORES(dni),
    CONSTRAINT FK_IMPARTE-ASIGNATURAS FOREIGN KEY(asignatura) REFERENCES ASIGNATURAS(codigo)
